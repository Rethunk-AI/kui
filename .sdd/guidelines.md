...
See [PLAN_MODE_GUIDE.md](PLAN_MODE_GUIDE.md) for a walkthrough; [sdd-system.mdc](../.cursor/rules/sdd-system.mdc) for brief vs full SDD.
...
- **Format**: `<type>-<descriptive-name>` (conventional commit types: feat, fix, refactor, docs, chore)
- **Rules**: No numeric or sequential patterns (e.g. no 001, 002, 003)
- **Examples**:
  - `feat-user-authentication`
  - `feat-photo-organizer`
  - `refactor-cobra-viper-cli`
