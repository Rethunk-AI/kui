...
**References:** [docs/prd/decision-log.md](../../docs/prd/decision-log.md) §§0–4, [docs/prd/architecture.md](../../docs/prd/architecture.md), [specs/done/schema-storage/spec.md](../../done/schema-storage/spec.md)
